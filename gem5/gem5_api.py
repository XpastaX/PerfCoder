...
def parse_args():
    ...
    parser.add_argument('--timeout_seconds_binary', type=int, help='timeout seconds for binary', default=100)
    parser.add_argument('--timeout_seconds_gem5', type=int, help='timeout seconds for gem5', default=1200)
...
@app.route('/gem5/multiple_single_submissions', methods=['POST'])
...
def Ping():
    return jsonify({"status": "ok","check":"work"})
