...
class SFTConfig(trl.SFTConfig):
    ...
    dataset_cache_name: Optional[str] = field(
        default=None,
        metadata={"help": ("Path to the cached dataset.")}
    )

@dataclass
class CoSOptimizerConfig(trl.ScriptArguments):
    host: Optional[str] = field(
        default=None,
        metadata={"help": ("host of the optimizer")}
    )
    port: Optional[int] = field(
        default=8000,
        metadata={"help": ("port of the optimizer")}
    )

    model_name: Optional[str] = field(
        default=8000,
        metadata={"help": ("model_name of the optimizer")}
    )
...
class GRPOScriptArguments(trl.ScriptArguments):
    ...
    code_provider: Optional[str] = field(
        default="e2b",
        metadata={
            "help": "Provider for code execution. Options: 'e2b', 'local', 'morph', 'pie-gem5'.",
            "choices": ["e2b", "local", "morph", "pie-gem5"],
        },
    )
    ...
    cos_optimizer_prompt_template_file: Optional[str] = field(
        default=None,
        metadata={"help": ("Prompt template file")}
    )

    cos_optimizers: Optional[List[CoSOptimizerConfig]] = field(
        default_factory=list,
        metadata={"help": ("Config of Optimizers")}
    )
